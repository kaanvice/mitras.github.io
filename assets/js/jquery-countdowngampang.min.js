    ...
    $.fn.CountdownGampang = function (options, callback) {
        ...
        function prepareTemplate() {
            element.append('<div class="ClassyCountdown-wrapper">' +
                ...
                '<div class="ClassyCountdown-value"><div></div><span></span></div>' +
                '</div>' +
                '<div class="ClassyCountdown-secondsx">' +
                '<input type="text" />' +
                '<div class="ClassyCountdown-value"><div></div><span></span></div>' +
                '</div>' +
                '</div>');
            ...
            element.find('.ClassyCountdown-secondsx input').knob($.extend({
                width: '100%',
                displayInput: false,
                readOnly: true,
                max: 60
            ...
            element.find('.ClassyCountdown-secondsx .ClassyCountdown-value').attr('style', settings.style.seconds.textCSS);

            if (settings.labels) {
                element.find(".ClassyCountdown-days .ClassyCountdown-value > span").html(settings.labelsOptions.lang.days);
                element.find(".ClassyCountdown-hours .ClassyCountdown-value > span").html(settings.labelsOptions.lang.hours);
                element.find(".ClassyCountdown-minutes .ClassyCountdown-value > span").html(settings.labelsOptions.lang.minutes);
                element.find(".ClassyCountdown-seconds .ClassyCountdown-value > span").html(settings.labelsOptions.lang.secondsxx);
        ...
        function onResize() {
            ...
            element.find('.ClassyCountdown-secondsxx input').trigger('change');
        }
        ...
        var countdown = setInterval(function () {
            ...
            var secondsxx = Math.floor((sels % (1000 * 60)) / 1000);
            ...
            element.find('.ClassyCountdown-secondsx input').val(60 - secondsx).trigger('change');
            ...
            element.find('.ClassyCountdown-seconds .ClassyCountdown-value > div').html(secondxxs);
